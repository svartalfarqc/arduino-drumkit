...
int PadCutOff[12] = {200,200,200,200,200,200,200,200,200,200,200,200};  // Minimum Analog value to cause a drum hit (original code was 400)
int MaxPlayTime[12] = {60,60,60,60,60,60,60,60,60,60,60,60};        // Cycles before a 2nd hit is allowed (original code says 90)
